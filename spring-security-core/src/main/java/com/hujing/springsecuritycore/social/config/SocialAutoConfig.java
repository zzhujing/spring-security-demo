...
import com.hujing.springsecuritycore.properties.QQProperties;
import com.hujing.springsecuritycore.properties.SecurityProperties;
import com.hujing.springsecuritycore.social.qq.connet.QQConnectionFactory;
...
/**
 * @author hj
 * @create 2019-05-03 12:39
 */
@Configuration
@ConditionalOnProperty(prefix = "security.properties.social.qq", name = "app-id")
public class SocialAutoConfig extends SocialConfigurerAdapter {
    ...
    public void addConnectionFactories(ConnectionFactoryConfigurer connectionFactoryConfigurer, Environment environment) {
        ...
        QQConnectionFactory factory = new QQConnectionFactory(qq.getProviderId(), qq.getAppId(), qq.getAppSecret());
